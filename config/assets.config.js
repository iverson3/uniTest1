...
export default {
	...
	// 首页轮播图片组
	index_swiper_1: PATH + "/swiper/1.jpg",
	index_swiper_2: PATH + "/swiper/2.jpg",
	index_swiper_3: PATH + "/swiper/3.jpg",
	
	// search组件所需图标
	search_icon_search: PATH + "/zy-search/search.svg",
	search_icon_voice: PATH + "/zy-search/voice.svg",
	search_icon_delete: PATH + "/zy-search/delete.svg",
